 ...
 ?>
    <h2>Feedback</h2>
    <p class="lead text-center">Leave feedback for This website</p>
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" class="mt-4 w-75" >
      <div class="mb-3">
        <label for="name" class="form-label">Name</label>
        <!-- is invalid class is important bootstrap class, whatever is inside this
            div for instance gets echoed depending on this class existing
            or not -->
